...
public class Pagos extends javax.swing.JFrame {
    ...
    InformacionPago frmInformacionPagos = new InformacionPago();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imágenes/Tablas/Nombres/Nombre Pagos.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 70, 110, -1));
    ...
    private void jButtonInformacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonInformacionActionPerformed
        frmInformacionPagos.setVisible(true);
    ...
    private void cargarTabla(){
        try{
            ...
            String sql = "SELECT id_pago, fecha_pago, descripcion, monto_dolares, "
                    + "monto_bolivares, tasa_dolar, numero_casa2, id_deuda2 FROM pago";
            ...
            modelo.addColumn("Monto (Dolares)");
            modelo.addColumn("Monto (Bolivares)");
            modelo.addColumn("Tasa del Dolar (Bs)");
            modelo.addColumn("Casa");
            modelo.addColumn("ID Deuda");
